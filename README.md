...
| 学　员 |  1|2|3|4|5|6|7  | 当前 deadline <br>`11/30 24:00`-`完成任务4-不需要提交` |
|:----: |:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| 黄业兴 | √ |√|√|√| | |   |  |
| 李　妍 | √ |√|√|√| | |   |  |
| 李雅兰 | √ |√|√|√| | |   |  |
...
1. 复习 git 相关操作, 完善自己的`Notes/git.md`,指令内容按照自己实际用过的来写.我会根据你们写的内容来提问.
    
2. 在`cn.costream.site`和`costream.site`中提交`Pull Request`来修改自己的个人名片(很高兴看到你们在这个项目上提交了多次 PR, 考虑到这次只需修改一个文件,在网页上提交即可)
